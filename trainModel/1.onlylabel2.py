...
class DentalCariesDatasetLabel2Only(Dataset):
...
if __name__ == "__main__":
    ...
    dataset_full = DentalCariesDatasetLabel2Only(image_folder, json_folder, transforms=get_train_transform())
    val_percent = 0.3
    ...
    torch.save(model.state_dict(), "faster_rcnn_caries_label2only.pth")
